...
public class JdbcUserDao implements UserDao {
    ...
    public User createUser(RegisterUserDto user) {
        ...
        try {
            int newUserId = jdbcTemplate.queryForObject(insertUserSql, int.class, user.getUsername(), password_hash, user.getFirstName(), user.getLastName(), ssRole);
    ...
    private User mapRowToUser(SqlRowSet rs) {
        ...
        user.setFirstName(rs.getString("first_name")); // Mapping first name
        user.setLastName(rs.getString("last_name"));   // Mapping last name
