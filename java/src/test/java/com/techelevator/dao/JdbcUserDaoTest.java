...
public class JdbcUserDaoTest extends BaseDaoTest {
    protected static final User USER_1 = new User(1, "user1", "user1", "Test", "Test", "ROLE_USER");
    protected static final User USER_2 = new User(2, "user2", "user2", "Test", "Test", "ROLE_USER");
    private static final User USER_3 = new User(3, "user3", "user3", "Test", "Test", "ROLE_USER");
